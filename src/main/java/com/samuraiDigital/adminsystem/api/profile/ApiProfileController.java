...
@RestController
@OpenAPIDefinition(info = @Info(contact = @Contact(email = "dominik.ricko@gmail.com", name = "Dominik Ričko"), title = "Profile API", description = "API for fetching user profiles"))
